...
public class CutsceneQuest15 : MonoBehaviour
{
    ...
    void OnCutsceneEnd(PlayableDirector pd)
    {
        ...
        QuestManager.Instance.CompleteTask("Прийти на суд Ихвильнихта");
        QuestManager.Instance.CompleteTask("Узнать о том, правильным ли было решение");
    ...
    {
        PauseForDialogue();
        dialogueManager.StartDialogueByKey("DialogueQuest15", "Терентий");
    }
}
