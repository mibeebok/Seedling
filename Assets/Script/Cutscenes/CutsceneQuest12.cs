...
public class CutsceneQuest12 : MonoBehaviour
{
    ...
    void OnCutsceneEnd(PlayableDirector pd)
    {
        ...
        QuestManager.Instance.CompleteTask("Поговорить с Терентием");
        QuestManager.Instance.CompleteTask("Принять решение");
    }
    ...
    {
        PauseForDialogue();
        dialogueManager.StartDialogueByKey("DialogueQuest12", "Терентий");
    }
}
