...
public class CutsceneQuest14_1 : MonoBehaviour
{
    ...
    void OnCutsceneEnd(PlayableDirector pd)
    {
        ...
        GameObject terenty = GameObject.Find("bear_0");
        if (terenty != null) terenty.transform.position = new Vector3(-25.12168f, -32.14454f, 0f);
        GameObject tiolli = GameObject.Find("rabbit_0");
        if (tiolli != null) tiolli.transform.position = new Vector3(6.91f, 2.6f, 0f);

        QuestManager.Instance.CompleteTask("Пойти к Ихвильнихту");

        if (triggerZoneQ14_2 != null) triggerZoneQ14_2.SetActive(true);
    }
    ...
    {
        PauseForDialogue();
        dialogueManager.StartDialogueByKey("DialogueQuest14.1", "Гриша");
    }
}
