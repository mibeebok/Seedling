...
public class CutsceneQuest14_2 : MonoBehaviour
{
    ...
    void OnCutsceneEnd(PlayableDirector pd)
    {
        ...
        QuestManager.Instance.CompleteTask("Разоблачить Финника");
    ...
    {
        PauseForDialogue();
        dialogueManager.StartDialogueByKey("DialogueQuest14.2", "Терентий");
    }
}
